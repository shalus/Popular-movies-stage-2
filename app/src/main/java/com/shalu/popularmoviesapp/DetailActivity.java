...
import com.shalu.popularmoviesapp.databinding.ActivityDetailBinding;
import com.shalu.popularmoviesapp.R;
//import com.shalu.popularmoviesapp.databinding.ActivityDetailBinding;
import com.shalu.popularmoviesapp.data.MovieContract;
import com.shalu.popularmoviesapp.utilities.MovieDbJsonUtils;
import com.shalu.popularmoviesapp.utilities.NetworkUtils;
...
public class DetailActivity extends AppCompatActivity implements ReviewsAdapter.OnReviewsItemClickListener, LoaderManager.LoaderCallbacks<DetailActivity.MovieDetail> {
    private static final String TAG = DetailActivity.class.getName();

    private TrailerAdapter1 trailerAdapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trailerAdapter1 = new TrailerAdapter1(this);
        mDetailBinding.rvTrailers.setAdapter(trailerAdapter1);
...
*/
    ...
    public Loader<MovieDetail> onCreateLoader(final int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<MovieDetail>(this) {
            ...
            public MovieDetail loadInBackground() {
                ...
                detail.trailerKeys = MovieDbJsonUtils.getResultsFromJson(trailerResponse,MD_TRAILER_KEY);
    ...
    public void onLoadFinished(Loader<MovieDetail> loader, MovieDetail data) {
        ...
        if(data.trailerNames!=null && data.trailerNames.length > 0) {
            makeVisibleTrailers();
            trailerAdapter1.setmTrailerName(data.trailerKeys);
    ...
    private void shareText(String textToShare) {
        ...
        String title = "Check this movie out!";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.share_movie) {
            shareText("Check this movie out: "+mMovieTitle+"\nRelease date: "+mReleaseDate+"\nRating: "+mRating+"\nOverview: "+mDesc);
            return true;
        }
